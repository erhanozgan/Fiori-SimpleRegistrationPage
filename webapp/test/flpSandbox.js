		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#RegistrationFormregistrationpage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"RegistrationFormregistrationpage-display": {
								"semanticObject": "RegistrationFormregistrationpage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=RegistrationForm.registrationpage",
									"url": sap.ui.require.toUrl("RegistrationForm/registrationpage")
								}
							}
						}
					}
